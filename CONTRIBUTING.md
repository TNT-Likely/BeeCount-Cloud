...
感谢你对 BeeCount Cloud 的关注！欢迎通过 Issue 反馈问题、通过 Pull Request 贡献代码。
...
BeeCount / BeeCount Cloud 采用「免费非商用 + 付费商业授权」的双许可模式（见 [LICENSE](LICENSE)）。为使该模式可持续，向本仓库提交贡献（PR / patch / 翻译等）即表示你同意：
