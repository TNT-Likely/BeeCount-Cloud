...
_DETAIL_ERROR_CODE_RULES: list[tuple[str, str]] = [
    ...
    ("invite not found", "SHARE_INVITE_NOT_FOUND"),
    ("invite exhausted", "SHARE_INVITE_EXHAUSTED"),
    ("share member user not found", "SHARE_MEMBER_USER_NOT_FOUND"),
    ("member not found", "SHARE_MEMBER_NOT_FOUND"),
    ("owner cannot leave ledger", "SHARE_OWNER_CANNOT_LEAVE"),
    ("owner role is immutable", "SHARE_OWNER_ROLE_IMMUTABLE"),
    ("share role forbidden", "SHARE_ROLE_FORBIDDEN"),
